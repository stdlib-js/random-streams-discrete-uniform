...
tape( 'the function returns a function which throws an error if minimum support `a` is not an integer primitive', function test( t ) {
	var values;
	var i;
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory();
			createStream( value, 2 );
		};
	}
});

tape( 'the function returns a function which throws an error if minimum support `a` is not an integer primitive (parameters)', function test( t ) {
	var values;
	var i;
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory( value, 2 );
			createStream();
		};
	}
});

tape( 'the function returns a function which throws an error if maximum support `b` is not an integer primitive', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns a function which throws an error if maximum support `b` is not an integer primitive (parameters)', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns a function which throws an error if minimum support `a` is greater than maximum support `b`', function test( t ) {
	var values;
	var i;
	...
	function badValue( arr ) {
		return function badValue() {
			var createStream = factory();
			createStream( arr[0], arr[1] );
		};
	}
});

tape( 'the function returns a function which throws an error if minimum support `a` is greater than maximum support `b` (parameters)', function test( t ) {
	var values;
	var i;
	...
	function badValue( arr ) {
		return function badValue() {
			var createStream = factory( arr[0], arr[1] );
			createStream();
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided an options argument which is not an object (parameters)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory( 2, 5, value );
			createStream();
		};
	}
});
...
tape( 'the function returns a factory function which creates stream instances', function test( t ) {
	...
	for ( i = 0; i < 10; i++ ) {
		t.strictEqual( createStream( 2, 5 ) instanceof RandomStream, true, 'returns expected value' );
	}
	t.end();
});
