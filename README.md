...
```bash
npm install @stdlib/random-streams-discrete-uniform
```
...
```bash
npm install -g @stdlib/random-streams-discrete-uniform-cli
```
...
```text
Usage: random-discrete-uniform [options] <a> <b>
...
```bash
$ random-discrete-uniform 2 5 -n 10 --seed 1234
```
