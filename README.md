...
> Create a [readable stream][readable-stream] for generating pseudorandom numbers drawn from a [discrete uniform][discrete-uniform-distribution] distribution.
...
```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-discrete-uniform@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-streams-discrete-uniform/tags). For example,

```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-discrete-uniform@v0.2.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var randomStream = require( 'path/to/vendor/umd/random-streams-discrete-uniform/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-discrete-uniform@umd/browser.js"></script>
```
...
Returns a [readable stream][readable-stream] for generating pseudorandom numbers drawn from a [discrete uniform][discrete-uniform-distribution] distribution with parameters `a` (minimum support) and `b` (maximum support).
...
var stream = randomStream( 2, 5, opts1 );
...
If provided a PRNG for random integers, this value is `null`.
...
Returns a `function` for creating [readable streams][readable-stream] which generate pseudorandom numbers drawn from a [discrete uniform][discrete-uniform-distribution] distribution.
...
```javascript
var createStream = randomStream.factory( 2, 5 );
...
var stream1 = createStream( 2, 5 );
var stream2 = createStream( 2, 5 );
// ...
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-streams-discrete-uniform.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-streams-discrete-uniform

[test-image]: https://github.com/stdlib-js/random-streams-discrete-uniform/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/random-streams-discrete-uniform/actions/workflows/test.yml?query=branch:v0.2.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-streams-discrete-uniform/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-streams-discrete-uniform?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-streams-discrete-uniform.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-streams-discrete-uniform/main
...
[cli-section]: https://github.com/stdlib-js/random-streams-discrete-uniform#cli
[cli-url]: https://github.com/stdlib-js/random-streams-discrete-uniform/tree/cli
[@stdlib/random-streams-discrete-uniform]: https://github.com/stdlib-js/random-streams-discrete-uniform/tree/main

[umd]: https://github.com/umdjs/umd
[es-module]: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules

[deno-url]: https://github.com/stdlib-js/random-streams-discrete-uniform/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-streams-discrete-uniform/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-streams-discrete-uniform/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-streams-discrete-uniform/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-streams-discrete-uniform/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-streams-discrete-uniform/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-streams-discrete-uniform/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-streams-discrete-uniform/main/LICENSE
