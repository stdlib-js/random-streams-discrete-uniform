...
/**
* Class for creating readable streams which generate a stream of pseudorandom numbers drawn from a discrete uniform distribution.
*/
declare class RandomStream extends Readable {
	...
	*
	* @example
	* var stream = new RandomStream( 2, 5 );
...
interface Constructor {
	...
	* stream.pipe( inspectStream( log )  );
	*/
	new( a: number, b: number, options?: Options ): RandomStream; // newable
	...
	* stream.pipe( inspectStream( log )  );
	*/
	( a: number, b: number, options?: Options ): RandomStream; // callable
	...
	* };
	*
	* var createStream = RandomStream.factory( 2, 5, opts );
	*
	...
	*/
	...
	/**
	* Returns an "objectMode" readable stream for generating a stream of pseudorandom numbers drawn from a discrete uniform distribution.
	*
	* @param a - minimum support
	* @param b - maximum support
	* @param options - stream options
	...
	*/
	objectMode( a: number, b: number, options?: Options ): RandomStream;
}
